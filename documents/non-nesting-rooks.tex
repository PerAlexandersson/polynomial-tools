...
Proposition~\ref{prop:ordered_tnn} gives a clean structural explanation for the
exact-\(b\) coefficient matrix, but we have not yet turned it into a proof of
Conjecture~\ref{conj:ordered_big_blocks_rr}. It strongly suggests that the
ordered big-block family belongs to the same TNN/planar-network world as other
real-rooted enumerative triangles.
\end{remark}
