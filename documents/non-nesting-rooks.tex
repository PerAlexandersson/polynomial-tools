...
\]
is the exponential Riordan array \((g,f)\). Thus a plausible extension of the
Br\"and\'en--Leite method would be a total-nonnegativity criterion for the whole
exponential Riordan array, or for its production matrix, rather than separate
