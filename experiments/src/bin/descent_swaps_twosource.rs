...
fn main() {
    ...
    for n in 4..=max_n {
        ...
        for (&mask, target_class) in &by_descent {
            ...
            for &p in &vp {
                ...
                let target_vals: Vec<usize> = target_class
                    .iter()
                    ...
                    if let Some(desc_class) = by_descent_prev.get(&sp_d) {
                        for pi in desc_class {
                            ...
                            if !e1 {
                                ...
                                println!(
                                    "  BUG: eps1=1 in desc source! n={} S={} p={} pi={:?}",
                                    n, s_str, p, pi
                                );
                            }
        ...
        println!(
            "n={}: recurrence {}/{}, eps1=0 in desc-source: {}/{}",
    ...
    println!("\n=== SUMMARY ===");
    println!(
        "Two-source recurrence correct: {}/{}",
        total_ok, total_checks
    );
    println!(
        "eps1 = 0 in descent-source: {}/{}",
        total_eps1_zero_in_desc, total_eps1_checks_in_desc
    );
