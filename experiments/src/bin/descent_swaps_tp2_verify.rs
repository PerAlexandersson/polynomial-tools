...
fn main() {
    ...
    for n in 4..=max_n {
        ...
        for (&mask, class) in &by_descent {
            ...
            if consec_ok { consec_interlace_ok += 1; }
            ...
            if all_inter { all_interlace_ok += 1; }
        ...
        println!("n={}: total={}, TP_2={}, consec_inter={}, all_inter={}, compat={}",
