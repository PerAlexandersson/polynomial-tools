...
use experiments::peak_utils::{board_to_perm, gen_boards, pa, peak_count, pmt, pz};
        ...
        for board in &boards {
            ...
            for j in 1..=m {
                for l in 1..=m {
                    ...
                    aw_all[0] += 1;
                    if !exact_interlaces(&bd.a[j], &bd.w[l]) {
                        aw_all[1] += 1;
                    }
                }
            }
            ...
            for j in 1..=m {
                for l in 1..=m {
                    ...
                    dw_all[0] += 1;
                    if !exact_interlaces(&bd.d[j], &bd.w[l]) {
                        dw_all[1] += 1;
                    }
                }
            }
            ...
            for j in 1..=m {
                for l in j + 1..=m {
                    ...
                    dd_fwd[0] += 1;
                    if !exact_interlaces(&bd.d[j], &bd.d[l]) {
                        dd_fwd[1] += 1;
                    }
                }
            }
            ...
            for j in 1..=m {
                for l in j + 1..=m {
                    if pz(&bd.d[l]) || pz(&bd.d[j]) {
                        continue;
                    }
                    dd_rev[0] += 1;
                    if !exact_interlaces(&bd.d[l], &bd.d[j]) {
                        dd_rev[1] += 1;
                    }
                }
            }
            ...
            for j in 1..=m {
                for l in 1..j {
                    ...
                    uu_rev[0] += 1;
                    if !exact_interlaces(&bd.u[j], &bd.u[l]) {
                        uu_rev[1] += 1;
                    }
                }
            }
            ...
            for mp in 1..=m {
                for j in 1..=mp {
                    for l in 1..=mp {
                        ...
                        aw_plus[0] += 1;
                        if !exact_interlaces(&a_plus, &w_plus) {
                            aw_plus[1] += 1;
                        }
                    }
                }
