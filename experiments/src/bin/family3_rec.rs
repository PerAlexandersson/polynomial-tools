...
fn main() {
    ...
    match find_recurrence_adaptive(&polys, &opts) {
        Some(res) => {
            ...
            println!("Params: rec_len={} var_deg={} idx_deg={} diff_deg={} denom=({},{})",
                res.opts.rec_len, res.opts.var_deg, res.opts.idx_deg, res.opts.diff_deg,
                res.opts.denom_var_deg, res.opts.denom_idx_deg);
        }
        None => println!("(none)"),
    }
}
