...
fn main() {
    ...
    for n in 1..=max_n {
        ...
        println!(
            "n={}: boards={}, S≼T fails={}, A^+≼W^+ fails={}",
            n, total, st_fails, aw_fails
        );
    }
    ...
    println!(
        "Phase 2: W_j≼W_l fails={}, W_i≼T_l fails={}, T_j≼T_l fails={}",
        ww_fails, wt_fails, tt_fails
    );

    println!("\n=== SUMMARY ===");
    println!(
        "Total: {}, S_k≼T_k fails: {}, A_j^+≼W_l^+ fails: {}",
        total, st_fails, aw_fails
    );
    println!(
        "W_j≼W_l: {}, W_i≼T_l: {}, T_j≼T_l: {}",
        ww_fails, wt_fails, tt_fails
    );
